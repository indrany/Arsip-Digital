...
<head>
    ...
    <title>Sistem Arsip Paspor | @yield('title', 'Dashboard')</title>
            ...
            <div class="v1_205 sidebar-header">
                ...
                <div class="v1_208"></div> 
                    <div class="sidebar-text-group">
                        <span class="sidebar-system-title">Sistem Arsip Paspor Akuntabel</span>
        ...
        <footer class="footer-siardig">
            <div class="text-center">
                <span class="text-muted small">
                    &copy; 2026 <strong>SAPA - KANIM PERAK</strong> Sistem Arsip Paspor Akuntabel | Kantor Imigrasi Kelas I TPI Tanjung Perak
                </span>
            </div>
        </footer>
    </div>
